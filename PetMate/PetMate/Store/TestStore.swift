...
class TestStore {
    ...
    init() {
        self.testPost = MatePost(
            ...
            firstPet: Pet(name: "애옹", description: "애옹 설명", age: 2, category1: "강아지", tag: ["귀여움"], breed: "봄베이고양이", images: ["https://d3544la1u8djza.cloudfront.net/APHI/Blog/2020/10-22/What+Is+a+Bombay+Cat+_+Get+to+Know+This+Stunning+Breed+_+ASPCA+Pet+Health+Insurance+_+close-up+of+a+Bombay+cat+with+gold+eyes-min.jpg"],
                          ownerUid: "희철",
                          createdAt: .now,
                          updatedAt: .now),
            createdAt: .now,
